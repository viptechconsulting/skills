...
process.env.SESSION_COOKIE_NAME = "lynkro_session_test";
...
process.env.DATABASE_URL =
  process.env.API_TEST_DATABASE_URL ?? "postgresql://postgres:postgres@localhost:5432/lynkro_outbound_test_api";

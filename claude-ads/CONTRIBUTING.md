...
Open a [GitHub Issue](https://github.com/viptechconsulting/skills/issues) with:
...
Use [GitHub Discussions](https://github.com/viptechconsulting/skills/discussions) for feature ideas and questions.
...
```bash
git clone https://github.com/viptechconsulting/skills.git
cd skills/claude-ads
bash install.sh
```

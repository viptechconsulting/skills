...
- **GitHub Issues**: [Open an issue](https://github.com/viptechconsulting/skills/issues)
- **Private report**: [GitHub Security Advisory](https://github.com/viptechconsulting/skills/security/advisories/new)
